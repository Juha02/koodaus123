...
def tarkista_hetu(hetu):
    """[Tarkistaa, että henkilötunnus on oikein muodostettu käyttäen modulo 31 tarkistetta]
    ...
    # Yhdistetään merkkijonot luvuksi tarkistetaan laskentaa varten 130 728 478
    luku_str = paivat_str + kuukaudet_str + vuodet_str + jarjestysnumero_str
    print('yhdistettynä se on', luku_str)
